...
public class Config {
    ...
    //存放老师上传的题目
    public static final String title = "D:/QQ/temp/task/teacher/upload/topic/";
    //存放学生提交的作业存放路径
    public static final String task = "D:/QQ/temp/task/student/homework/upload/";
    //评分文件生成目录
    public static final String IMPORT_INFO = "D:/QQ/temp/task/student/importInfo/";
    //临时存放打包压缩文件位置
    public static final String TEMP_COMPRESS_PATH = "D:/QQ/temp/task/temp/download/";
